...
Check/install Git, GitHub CLI, and Node/npm as needed. Start GitHub's HTTPS browser authentication through gh auth login --web when necessary; the user signs in and approves. Configure Git authentication through gh auth setup-git. Do not ask for tokens in chat.
