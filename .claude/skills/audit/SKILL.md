...
**Operating manual:** `AGENTS.md` (root), `CLAUDE.local.md` (gitignored).
...
| # | Domain | Examples |
|---|---|---|
| 1 | Revenue / Financials | Stripe, GoHighLevel, QuickBooks, Looker |
| 2 | Customer interactions | HubSpot, Salesforce, Gmail-as-CRM |
