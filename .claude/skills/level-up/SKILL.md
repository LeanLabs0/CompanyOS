...
- `references/operator-framework.md`, the framework (used to quote principles back)
...
9. **Framework reference on output.** Every report and every scaffolded artifact references the operator framework file.

## Verification (for the implementer)

- **Dry run on a sample user** with no prompt. Expected: skill surfaces 2-3 candidates pulled from his recent activity, priorities, and top_pain. Generic output ("you should build a brief") = fail.
